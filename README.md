...
This payload is auto-loaded by ezRemote Client when it starts up or can be added to any other auto payload loaders like ps5_y2jb_autoloader or ps5_lua_loader etc...
